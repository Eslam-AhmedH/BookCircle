  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-surface px-6 text-center">
      <div className="relative mb-6 flex items-center justify-center">
        <span className="absolute text-[12rem] font-black leading-none text-primary/5 select-none">
          404
        </span>
      ...
      <p className="mb-3 text-[clamp(5rem,14vw,8rem)] font-black leading-none tracking-tight text-primary drop-shadow-[0_0_60px_rgba(210,187,255,0.25)]">
        404
      </p>
